...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		Scheme: scheme,
		Cache:  cache.Options{DefaultNamespaces: map[string]cache.Config{"good-patch": {}}},
	...
	if err = (&controller.GoodPatchReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to set up good-patch controller"); os.Exit(1)
	}
	...
	setupLog.Info("starting good-patch controller (5 workers, predicate ON, Patch)")
