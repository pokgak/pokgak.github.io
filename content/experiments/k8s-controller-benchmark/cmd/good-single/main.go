...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		Scheme: scheme,
		Cache:  cache.Options{DefaultNamespaces: map[string]cache.Config{"good-single": {}}},
	...
	if err = (&controller.GoodSingleReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to set up good-single controller")
		os.Exit(1)
	}
	...
	setupLog.Info("starting good-single controller (1 worker, predicate ON)")
