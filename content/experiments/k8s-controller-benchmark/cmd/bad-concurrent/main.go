...
func main() {
	...
	if err = (&controller.BadConcurrentReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to set up bad-concurrent controller")
		os.Exit(1)
	}
	...
	setupLog.Info("starting bad-concurrent controller manager")
